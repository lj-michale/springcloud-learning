...
package org.springcloud.turing.biz.ticketservice.controller;
...
public class TicketController {
    ...
    @ILog
    @Idempotent(
            uniqueKeyPrefix = "turing-ticket:lock_purchase-tickets:",
            key = "T(org.springcloud.turing.framework.starter.bases.ApplicationContextHolder).getBean('environment').getProperty('unique-name', '')"
                    + "+'_'+"
                    + "T(org.springcloud.turing.frameworks.starter.user.core.UserContext).getUsername()",
