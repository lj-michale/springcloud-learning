...
import org.springcloud.turing.biz.common.constant.RedisKeyConstant;
import org.springcloud.turing.biz.common.enums.UserChainMarkEnum;
import org.springcloud.turing.biz.common.enums.UserRegisterErrorCodeEnum;
import org.springcloud.turing.biz.dao.entity.req.UserDeletionReqDTO;
import org.springcloud.turing.biz.dao.entity.req.UserLoginReqDTO;
import org.springcloud.turing.biz.dao.entity.req.UserRegisterReqDTO;
import org.springcloud.turing.biz.dao.entity.resp.UserLoginRespDTO;
import org.springcloud.turing.biz.dao.entity.resp.UserQueryRespDTO;
import org.springcloud.turing.biz.dao.entity.resp.UserRegisterRespDTO;
import org.springcloud.turing.biz.service.UserLoginService;
import org.springcloud.turing.biz.service.UserService;
import org.springcloud.turing.biz.toolkit.UserReuseUtil;
import org.springcloud.turing.biz.dao.entity.UserDO;
import org.springcloud.turing.biz.dao.entity.UserDeletionDO;
import org.springcloud.turing.biz.dao.entity.UserMailDO;
import org.springcloud.turing.biz.dao.entity.UserPhoneDO;
import org.springcloud.turing.biz.dao.entity.UserReuseDO;
import org.springcloud.turing.biz.dao.mapper.UserDeletionMapper;
import org.springcloud.turing.biz.dao.mapper.UserMailMapper;
import org.springcloud.turing.biz.dao.mapper.UserMapper;
import org.springcloud.turing.biz.dao.mapper.UserPhoneMapper;
import org.springcloud.turing.biz.dao.mapper.UserReuseMapper;
...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public Boolean hasUsername(String username) {
        ...
        if (hasUsername) {
            ...
            return instance.opsForSet().isMember(RedisKeyConstant.USER_REGISTER_REUSE_SHARDING + UserReuseUtil.hashShardingIdx(username), username);
        }
        return true;
    }
    ...
    public UserRegisterRespDTO register(UserRegisterReqDTO requestParam) {
        ...
        try {
            ...
            StringRedisTemplate instance = (StringRedisTemplate) distributedCache.getInstance();
            instance.opsForSet().remove(RedisKeyConstant.USER_REGISTER_REUSE_SHARDING + UserReuseUtil.hashShardingIdx(username), username);
    ...
    public void deletion(UserDeletionReqDTO requestParam) {
        ...
        try {
            ...
            StringRedisTemplate instance = (StringRedisTemplate) distributedCache.getInstance();
            instance.opsForSet().add(RedisKeyConstant.USER_REGISTER_REUSE_SHARDING + UserReuseUtil.hashShardingIdx(username), username);
        } finally {
            lock.unlock();
        }
    }
